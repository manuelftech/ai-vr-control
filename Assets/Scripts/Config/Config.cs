...
namespace AIControlVR.Configuration
{
    public class Config
    {
        public static readonly string ApiTemplate = Environment.GetEnvironmentVariable("VR_TEMPLATE_API_ENDPOINT") ?? "http://localhost:5000/vr-state/transform-template";
        public static readonly string ApiSessionStates = Environment.GetEnvironmentVariable("VR_STATE_API_ENDPOINT") ?? "http://localhost:5000/vr-state/session-states";
        public static readonly string ApiSessionStatesStream = Environment.GetEnvironmentVariable("VR_INFO_API_ENDPOINT") ?? "http://localhost:5000/vr-state/session-states/stream";
        public static readonly string ApiScreenshot = Environment.GetEnvironmentVariable("VR_INFO_API_ENDPOINT") ?? "http://localhost:5000/vr-state/screenshot";
        ...
        public static readonly string ScreenshotTag = Environment.GetEnvironmentVariable("STREAMING_TAG") ?? "RemoteDesktopStream";
        public static readonly string VisibilityTag = Environment.GetEnvironmentVariable("VISIBILITY_BUTTON_TAG") ?? "visibility_image";
    }
}